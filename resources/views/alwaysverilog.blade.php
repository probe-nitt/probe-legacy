...
<h1 data-splitting>Description</h1>
        <p>Modeling electronic systems using Verilog is one of the most sought-after skills in the industry these days. This year, Probe brings you Always@(Verilog), where participants compete in a two-round contest that tests their Verilog knowledge and general aptitude using a mix of objective and coding questions.</p>
