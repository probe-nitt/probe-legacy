...
<body id="top">
   ...
   ================================================== -->
    ...
    <div class="page">
        ...
        <p>
        A son asked his father, a programmer, why the sun rises in the east and sets in the west. His response was, "It works, don't touch!". We have an event for you in-store if you can relate to this!
        </p>
        ...
        <ul>
            <li>Contest will be held in Hackerrank. All programming languages are accepted.</li>
            <li>Write code in the online code editor that is provided with each problem and submit it.</li>
            <li>You can make multiple submissions. The platform automatically considers the best submission.</li>
        </ul>

        <h1 data-splitting>Event date:</h1>

        <ul>
            <li>25 Feb (5:30 - 7:00 PM)</li>
        </ul>

        <h1 data-splitting>Prizes</h1>

        <ul>
            <li>Prizes worth INR 10k for the top 3 participants combined.</li>
        </ul>
