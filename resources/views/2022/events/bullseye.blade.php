...
<li><a href="/combos" title="">Combos</a></li>
    ...
    <div class="page">
        ...
        <p>
        "The harder the game is to solve, the more fun you can have, right?" Detectives can be found in movies and books, but do you think you have the necessary skills to be one?
        </p>
        ...
        <ul>
            <li>Each team can consist of upto 2 members. </li>
            <li>A website link will be given which will contain a set of questions to be solved to discover the clue which will redirect them to another website and this goes on till they reach the destination website.</li>
        </ul>

        <h1 data-splitting>Event Date</h1>

        <ul>
            <li>27th Feb (5:30 PM - 6:30 PM)</li>
        </ul>
        ...
        <ul>
            <li>This is a team event (upto 2 people per team).</li>
