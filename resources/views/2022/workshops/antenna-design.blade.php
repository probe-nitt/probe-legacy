...
<body id="top">
    ...
    <div class="hero-nav">
        <div class="hero-nav__inner">
            <h1 style="text-align:center;">ANTENNA DESIGN AND TESTING WORKSHOP</h1>
        </div>
        <div class="hero-nav__broughtby">
            <span style="font-size: 20px">organized by</span>
            <a href="https://www.entuple.com/" target="_blank">
                <img style="background: white; width: 120px; height: 60px;" src="/images/entuple_logo.png">
            </a>
        </div>
    </div>
    <!-- header 
...
<li><a href="/combos" title="">Combos</a></li>
    ...
    <div class="page">
        ...
        <p>Do you know what communication is? Of course, you do. But have you ever thought of how ISRO and DRDO make it possible for us to communicate with someone across the globe almost instantaneously and with perfect precision?</p>
        <p>Well, what are you waiting for? Join us in this workshop, to plunge into the world of Antenna design and testing! This workshop, organized by Entuple Technologies, will help you learn about the latest techniques in antenna design with the help of HFSS EM field simulation software!</p>
        ...
        <p><img style="background: white; width: 120px; height: 60px;" src="/images/entuple_logo.png"></p>
