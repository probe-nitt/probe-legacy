...
<body id="top">
    ...
    <div class="hero-nav">
        <div class="hero-nav__inner">
            <h1 style="text-align:center;">COMPILER DESIGN ENABLING IMAGE PROCESSING <br>AND MACHINE LEARNING</h1>
        </div>
        <div class="hero-nav__broughtby">
            <span style="font-size: 20px">organized by</span>
            <a href="https://www.qualcomm.com/" target="_blank">
                <img style="width: 180px; height: 60px;" src="/images/Qualcomm_whitelogo.png">
            </a>
        </div>
    </div>
    <!-- header 
   ================================================== -->
    ...
    <div class="page">
        ...
        <p>
        Mobile phones have changed significantly in the last 25 years, changing from a voice-calls only device to an always-connected powerful computing machine. This fantastic technical achievement happened mainly through hardware design and software changes adapting to the hardware changes. 
        </p>
        <p>
        We are delighted to present to you, a workshop on "Compiler Design enabling Image Processing and Machine Learning" organized in association with Qualcomm! The workshop will be conducted by Mr. Sushim, Senior Director Engineering, Qualcomm. Sushim started his career as a 3G protocol stack engineer, moving forward to take on various roles in domains including Chipset Software, 4G and 5G connectivity, multimedia and application processor software, etc., He has an experience of 22 years working in these domains! 
        </p>
        <p>
        Join us on 26th February 2022, to get yourself equipped with the latest trends and the challenges to sustaining this kind of rapid evolution, the need for hardware accelerators and the increased significance of compilers!
        </p>

        <h1 data-splitting>Workshop details</h1>

        <ul>
            <li>Date: 26th February
            <li>Duration: 1 day</li>
            <li>Timings: 2:00 PM - 5:00 PM
            <li>Fee : 250 INR</li>
        ...
        <ul>
            <li><strike>250</strike> 215 INR</li>
