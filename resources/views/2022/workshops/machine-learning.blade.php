...
<body id="top">
    ...
    <div class="hero-nav">
        <div class="hero-nav__inner">
            <h1 style="text-align:center;">MACHINE LEARNING ON HARDWARE</h1>
        </div>
    </div>
    <!-- header 
   ================================================== -->
...
<li><a href="/combos" title="">Combos</a></li>
	...
	Here we are, presenting the workshop, "Machine learning on hardware" where we will be implementing artificial neural networks using Verilog! Join us in this workshop to learn how to recognize handwritten digits using an artificial neural network built using Verilog HDL, Quartus prime lite and Modelsim software!
        ...
        <ul>
            <li>Date: 
                <ul>
                    <li>Feb 27th (Session 1 & Session 2)</li>
                    <li>Feb 28th (Session 3)</li>
                </ul>
            ...
            <li>Timings:
                <ul>
                    ...
                    <li>Session 3: 5:00 PM - 8:00 PM</li>
                </ul>
            <li>Fee : 200 INR</li>
        ...
        <h1 data-splitting>Requirements</h1>

        <ul>
            <li>
            A PC with following configurations:
                <ul>
                    <li>Windows 10/11 or Linux OS</li>
                    <li>4GB RAM and atleast 16GB of free disk space for proper working</li>
                </ul>
            </li>
        </ul>

        <h1 data-splitting>Installations</h1>
        <ul>
            <li>Intel's Quartus prime lite edition and Modelsim softwares (proper installation guide will be provided prior to the workshop)</li>
        </ul>
